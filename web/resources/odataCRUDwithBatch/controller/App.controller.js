...
sap.ui.define([
	"opensap/odataCRUDwithBatch/controller/BaseController",
	"sap/ui/model/json/JSONModel"
], function(BaseController, JSONModel) {
	"use strict";

	return BaseController.extend("opensap.odataCRUDwithBatch.controller.App", {
		...
		onBatchDialogPress: function() {
			...
			view._bDialog = sap.ui.xmlfragment("opensap.odataCRUDwithBatch.view.batchDialog", this );// associate controller with the fragment
